...
Я начинающий фронтенд-разработчик, начала изучать самостоятельно программирование в начале 2022г. Ранее я пробовала изучать различные направления: тестировщик по, инженерная графика в AutoCAD, работа с Photoshop, Illustrator. Отправной точкой стало знакомство с веб-разработкой на Яндекс.Практика. Прошла базовое знакомство со специализацией и поняла, что это то, в чем бы хотела действительно развиваться! Занималась на тренажерах таких как: HTMLAcademiy, Code-basics. Пробовала верстать простые учебные проекты. 11.2022г поступила на курс Frontend разработчик в GeekBrains, где обучаюсь по сей день.
...
![codewars](https://www.codewars.com/users/MoraKsu/badges/large)
